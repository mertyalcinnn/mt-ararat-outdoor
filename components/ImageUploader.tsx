...
export default function ImageUploader({ onImageUpload, currentImageUrl = '', label = 'Resim Yükle' }: ImageUploaderProps) {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 10 * 1024 * 1024) {
      setUploadError('Dosya boyutu çok büyük. Lütfen 10MB\'dan küçük bir dosya seçin.');
      return;
    }
  ...
  if (!clientReady) {
    return <div className="w-full h-28 bg-slate-100 rounded-lg animate-pulse"></div>;
  }
