...
interface DirectInstagramFeedProps {
  title: string;
  description: string;
  followText: string;
  lang: Locale;
...
export default function DirectInstagramFeed({
  title,
  description,
  followText,
  lang,
  ...
  // Instagram widget'ını yeniden yükleme işlevi
  useEffect(() => {
    // Instagram embedlerini yükle
  ...
  return (
    <section className="section bg-white">
      ...
      <div className="container-custom">
        ...
        {/* Instagram gömülü grid düzeni */}
        <div className={`grid grid-cols-1 md:grid-cols-${Math.min(columns, 4)} gap-4`}>
          {/* Instagram gömme kodları buraya gelecek */}
          <div className="instagram-embed-container" style={{width: '100%', maxWidth: '100%'}}>
            <blockquote 
                ...
                >
                  ...
                  <div style={{paddingTop: '8px'}}>
                    <div style={{
                      ...
                      Bu profili Instagram'da görüntüle
                    </div>
                  </div>
