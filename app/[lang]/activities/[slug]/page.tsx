...
export default async function ActivityDetailPage({
  ...
  console.log(
    `[${new Date().toISOString()}] [${
      params.lang
    }] Aktivite detay sayfası render ediliyor: "${params.slug}"`
  );
  ...
  if (!activity) {
    return (
      <div className="relative mt-24 pt-16 pb-12 text-center">
        {" "}
        {/* Header için yeterli boşluk */}
  ...
  return (
    <div className="relative mt-24 pt-16 pb-12">
      {" "}
      {/* Header için yeterli boşluk */}
      <div className="container mx-auto px-4">
        {/* Hero Bölümü */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <svg
                    className="w-5 h-5 mt-0.5 text-blue-600 mr-3"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
              ...
              activity.includedServices.length > 0 && (
                <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                  ...
                  <ul className="space-y-2">
                    {activity.includedServices.map(
                      (service: string, idx: number) => (
                        <li key={idx} className="flex items-start">
                          <svg
                            className="w-5 h-5 mt-0.5 text-green-600 mr-3"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="bg-blue-600 rounded-xl shadow-lg p-6 text-white">
              ...
              <p className="mb-6">
                Bu aktivite hakkında daha fazla bilgi almak veya rezervasyon
                yapmak için bizimle iletişime geçin.
              </p>

              {activity.contactWhatsapp && (
                <a
                  href={`https://wa.me/${activity.contactWhatsapp.replace(
                    /\D/g,
                    ""
                  )}`}
                  target="_blank"
