...
export default async function AboutPage({
  ...
  const aboutPageTexts = {
    ...
    en: {
      ...
      ctaDescription:
        "Prepare for an unforgettable experience in the unique nature of Mount Ararat with our professional guides.",
      ctaButton: "Make a Reservation Now",
    },
    ru: {
      subtitle:
        "Качество и безопасность в профессиональном руководстве на открытом воздухе.",
      teamTitle: "Наша команда",
      ctaTitle: "Готовы к приключениям с нами?",
      ctaDescription:
        "Приготовьтесь к незабываемым впечатлениям в уникальной природе горы Арарат с нашими профессиональными гидами.",
  ...
  return (
    <div>
      <PageHeader title={aboutData.title} description={texts.subtitle} />
